        ...
        <>
            <div className="relative w-[90%] max-w-5xl mx-auto h-64">
                ...
                <div className="relative z-10 h-full flex flex-col md:flex-row md:justify-between items-center md:pl-6">
                    ...
                    <div className="relative group inline-block mt-4 md:mt-0 cursor-pointer">
                        <img
                        ...
                        />
                        {/* Table: */}
                        <div className="absolute left-1/2 -translate-x-1/2 md:left-auto md:right-0 md:translate-x-0 top-full mt-2 hidden group-hover:block bg-zinc-900 shadow-lg p-2 rounded-lg">
